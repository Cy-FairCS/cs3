...
public class QuickSortArrayTester
{
   public static void main(String... args) {
      ...
      IO.println("Original: " + Arrays.toString(array));
      QuickSortArray.sort(array);
      IO.println("count = " + QuickSortArray.count[0]);
      IO.println("Sorted:   " + Arrays.toString(array) + "\n");
      IO.println("Sort again to see count when it's already sorted:");
